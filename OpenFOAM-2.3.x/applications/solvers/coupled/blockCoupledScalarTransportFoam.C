...
#include "blockMatrixTools.H" // TODO: blockLduMatrix
...
#   include "CourantNo.H"
	...
	dictionary solversDict(mesh.solutionDict().subDict("solvers"));
        ...
        while (simple.correctNonOrthogonal())
        {
            ...
            BlockSolverPerformance<vector2> solverPerf =
                ...
                (
                    blockT.name(),
                    blockM,
                    solversDict.subDict(blockT.name())
                )->solve(blockX, blockB);
